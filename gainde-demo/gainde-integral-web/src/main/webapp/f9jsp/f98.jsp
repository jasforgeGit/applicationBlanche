...
selectedRadio5=selectedRadio4.substring(selectedRadio4.indexOf("")+1,selectedRadio4.length);
selectedRadio6=selectedRadio5.substring(selectedRadio5.indexOf("")+1,selectedRadio5.length);
selectedRadio7=selectedRadio6.substring(selectedRadio6.indexOf("")+1,selectedRadio6.length);
selectedRadio8=selectedRadio7.substring(selectedRadio7.indexOf("")+1,selectedRadio7.length);
 ...
 window.opener.document.forms.item(window.opener.document.forms.length-1).<%=sn.com.douane.web.f9.form.F9Form.getLibm6()%>.value = selectedRadio5.substring(0,selectedRadio5.indexOf(""));
 window.opener.document.forms.item(window.opener.document.forms.length-1).<%=sn.com.douane.web.f9.form.F9Form.getLibm7()%>.value = selectedRadio6.substring(0,selectedRadio6.indexOf(""));
 window.opener.document.forms.item(window.opener.document.forms.length-1).<%=sn.com.douane.web.f9.form.F9Form.getLibm8()%>.value = selectedRadio7.substring(0,selectedRadio7.indexOf(""));
 window.opener.document.forms.item(window.opener.document.forms.length-1).<%=sn.com.douane.web.f9.form.F9Form.getLibm9()%>.value = selectedRadio8.substring(0,selectedRadio8.indexOf("")); 
 window.opener.document.forms.item(window.opener.document.forms.length-1).<%=sn.com.douane.web.f9.form.F9Form.getLibm10()%>.value = selectedRadio8.substring(selectedRadio8.indexOf("")+1,selectedRadio8.length);
...
<%-- 			<th class="FORM2"><s:label name="lib7"/></th> --%>
<%-- 			<th class="FORM2"><s:label name="lib8"/></th> --%>
<%-- 			<th class="FORM2"><s:label name="lib9"/></th> --%>
<%-- 			<th class="FORM2"><s:label name="lib10"/></th> --%>
<!-- 		    </tr> -->
...
<%-- 			<td class="FORM3"><s:property value="col7" /></td> --%>
<%-- 			<td class="FORM3"><s:property value="col8" /></td> --%>
<%-- 			<td class="FORM3"><s:property value="col9" /></td> --%>
<%-- 			<td class="FORM3"><s:property value="col10" /></td> --%>
<!-- 		</tr> -->
<%-- 	</s:iterator> --%>
<!-- </table> -->
	...
	<s:url id="remoteurl" action="f9Grid"/>
	    <sjg:grid 
	        ...
	        width="800">
		    	...
		    	<sjg:gridColumn name="col7"  title="%{lib7}"/>
		    	<sjg:gridColumn name="col8"  title="%{lib8}" />
		        <sjg:gridColumn name="col9"  title="%{lib9}" />
		    	<sjg:gridColumn name="col10"  title="%{lib10}" />
	    </sjg:grid>
	 </div>	
