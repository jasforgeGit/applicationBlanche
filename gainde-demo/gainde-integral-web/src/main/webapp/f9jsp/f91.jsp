...
selectedRadio1=selectedRadio.substring(selectedRadio.indexOf("²")+1,selectedRadio.length);
 ...
 window.opener.document.forms.item(window.opener.document.forms.length-1).<%=sn.com.douane.web.f9.form.F9Form.getLibm3()%>.value = selectedRadio1.substring(selectedRadio1.indexOf("²")+1,selectedRadio1.length);
