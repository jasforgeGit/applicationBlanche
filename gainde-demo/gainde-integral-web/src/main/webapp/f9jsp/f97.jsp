...
selectedRadio7=selectedRadio6.substring(selectedRadio6.indexOf("²")+1,selectedRadio6.length);
 ...
 window.opener.document.forms.item(window.opener.document.forms.length-1).<%=sn.com.douane.web.f9.form.F9Form.getLibm9()%>.value = selectedRadio7.substring(selectedRadio7.indexOf("²")+1,selectedRadio7.length);
	...
	<s:url id="remoteurl" action="f9Grid"/>
	    <sjg:grid 
	        ...
	        width="800">
		    	...
		    	<sjg:gridColumn name="col6"  title="%{lib}"/>
