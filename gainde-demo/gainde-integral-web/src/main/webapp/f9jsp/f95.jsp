...
selectedRadio5=selectedRadio4.substring(selectedRadio4.indexOf("²")+1,selectedRadio4.length);
 ...
 window.opener.document.forms.item(window.opener.document.forms.length-1).<%=sn.com.douane.web.f9.form.F9Form.getLibm7()%>.value = selectedRadio5.substring(selectedRadio5.indexOf("²")+1,selectedRadio5.length);
