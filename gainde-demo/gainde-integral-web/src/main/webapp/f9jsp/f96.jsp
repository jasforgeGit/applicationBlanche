...
selectedRadio6=selectedRadio5.substring(selectedRadio5.indexOf("²")+1,selectedRadio5.length);
 ...
 window.opener.document.forms.item(window.opener.document.forms.length-1).<%=sn.com.douane.web.f9.form.F9Form.getLibm8()%>.value = selectedRadio6.substring(selectedRadio6.indexOf("²")+1,selectedRadio6.length); 
