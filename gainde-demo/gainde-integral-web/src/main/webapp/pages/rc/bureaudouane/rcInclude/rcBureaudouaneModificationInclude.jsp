...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="3"><s:text
				name="RcBureaudouaneFB.ModificationBureaudouane" /></th>
	</tr>
				<tr>
				...
				<tr>
					...
					<td><s:select name="numListRcTypeBurDouaneOB" cssStyle="width:200px;float: left;"
				...
				<tr>
					...
					<td><s:select name="numListRcCompetenceOB" cssStyle="width:200px;float: left;"
				...
				<tr>
					...
					<td><s:select name="numListRcGenreBurOB" cssStyle="width:200px;float: left;"
