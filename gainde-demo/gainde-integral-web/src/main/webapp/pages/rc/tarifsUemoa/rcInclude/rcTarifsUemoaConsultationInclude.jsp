...
<table class="SECTION">
	...
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numListRcCodPaysOB"
				id="TNUM_LIST_RCCODPAYS_OB" maxlength="3" onkeyup="f9_pays(this,event)"
		...
		<td><div style="float: left;"><s:textfield name="numRcTitreEnt" id="TNUM_RCTITREENT"
				maxlength="3" cssClass="input100" readonly="true"/></div></td>
	</tr>
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numRcAdresseEnt" id="TNUM_RCADRESSEENT"
				maxlength="60" cssClass="input100" readonly="true"/></div></td>
	</tr>
	<tr>
		<th><s:text name="RcAgrementEntrepriseFB.DAT_RCDATEAGREMENT" /></th>
		<td><div style="float: left;"><s:textfield id="DAT_RCDATEAGREMENT" name="datRcDateAgrement"
				 maxlength="10"
				cssClass="input100" readonly="true"/></div></td>
        <th><s:text name="RcAgrementEntrepriseFB.DAT_RCDATCLOTURE" /></th>
		<td><div style="float: left;"><s:textfield id="DAT_RCDATCLOTURE" name="datRcDatCloture"
				 maxlength="10"
				cssClass="input100" readonly="true"/></div></td>
	</tr>	
</table>
	...
	<table>
		<tr>
			<td><s:submit key="button.retour" cssClass="buttonBar"
					onclick="gotoUrl('rechercherRcTarifsUemoa','rechercheRcTarifsUemoa')"></s:submit></td>
		</tr>
	</table>
</div>
...
<table class="SECTION">
	...
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numRcAgrentOB"
				id="TNUM_RCAGRENT" maxlength="4" readonly="true"
				cssClass="input100" /></div></td>
		...
		<td><div style="float: left;"><s:textfield name="numListRcCodeProdOBrech" id="TNUM_LIST_RCCODEPROD_OBrech"
				onkeyup="f9_Produits(this,TNUM_LIST_RCPRECUEMOAPROD_OBrech,TNUM_LIST_RCPRECSENPROD_OBrech,event)"
	...
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numListRcPrecuemoaProdOBrech"
		     	onkeyup="f9_Produits(TNUM_LIST_RCCODEPROD_OBrech,this,TNUM_LIST_RCPRECSENPROD_OBrech,event)"
		...
		<td><div style="float: left;"><s:textfield name="numListRcPrecsenProdOBrech" id="TNUM_LIST_RCPRECSENPROD_OBrech"
				onkeyup="f9_Produits(TNUM_LIST_RCCODEPROD_OBrech,TNUM_LIST_RCPRECUEMOAPROD_OBrech,this,event)" 
