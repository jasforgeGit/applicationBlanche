...
<s:form method="post" theme="simple">
	<%@ include file="/pages/rc/tarifsUemoa/rcInclude/rcTarifsUemoaConsultationInclude.jsp"%>
...
<script type="text/javascript">
    ...
    "&pageContext=consultationRcProduitsUemoa'><img src='config/edit1.jpg' border='0' /></a>";
}
