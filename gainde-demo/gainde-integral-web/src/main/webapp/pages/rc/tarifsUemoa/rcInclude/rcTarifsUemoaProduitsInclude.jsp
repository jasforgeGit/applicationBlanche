...
<table class="SECTION">
	...
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numListRcCodeProdOB" readonly="true"
	...
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numListRcCodeTaxe" id="TNUM_LIST_RCCODETAXE"
				maxlength="2" cssClass="input100" onkeyup="f9_Taux(TNUM_LIST_RCCODETAUX,this)"/></div></td>
	</tr>
	<tr>
		<th><s:text name="RcAgrementEntrepriseFB.DAT_RCDATEAPPLICATION" /></th>
		<td><div style="float: left;"><sj:datepicker id="DAT_RCDATEAPPLICATION" name="datRcDateApplication"
		...
		<td><div style="float: left;"><s:textfield name="numListRcCodeTaux" id="TNUM_LIST_RCCODETAUX"
				maxlength="3" cssClass="input100" onkeyup="f9_Taux(this,TNUM_LIST_RCCODETAXE)"/></div></td>
	</tr>
	<tr>
		...
		<td><div style="float: left;"><sj:datepicker id="DAT_RCDATECLOTUREProd" name="datRcDateClotureProd"
				showOn="focus" displayFormat="dd/mm/yy" maxlength="10"
				cssClass="input100" /></div></td>
	</tr>
</table>
