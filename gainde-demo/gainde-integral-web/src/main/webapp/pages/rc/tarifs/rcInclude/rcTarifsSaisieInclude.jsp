...
<sx:tabbedpanel id="declSaisie">
	...
	<tr>
		...
		<td><s:textfield name="numListRcPrecUemoaOB" id="TNUM_LIST_RCPRECUEMOA_OB" maxlength="2"
	...
	<tr>
		...
		<td><s:textfield name="numListRcPrecSenegalOB"
	...
	<tr>
		...
		<td><s:textfield name="numListRcValChapitreOB" readonly="true"
				id="NUM_LIST_rcValChapitre_OB" maxlength="2" onkeyup="f9_ChapitreSection (this,event)"
				cssClass="input200" /></td>
		<td width="20%"></td>
...
<sx:div labelposition="top" key="RcTarifsFB.Fiscalite" cssStyle="margin-down: 5px;" >
	...
	<tr>
		...
		<td><s:textfield name="numListRcCodeTaxeOB" id="TNUM_LIST_RCCODETAXE_OB" maxlength="2"
		onkeyup="f9_Taux(TNUM_LIST_RCCODETAUX_OB,this,event)" 
				cssClass="input200"/></td>
	</tr>
	<tr>
		<th><s:text name="RcTarifsFB.TNUM_LIST_RCCODETAUX_OB" /></th>
		<td><s:textfield name="numListRcCodeTauxxOB"
	    ...
	    <td><sj:datepicker id="DAT_RCDATEVALEUR_OB" name="datRcDateValeurOB" showOn="focus" displayFormat="dd/mm/yy" cssStyle="width: 200px;"/></td>
	</tr>
	<tr>
		<th><s:text name="RcTarifsFB.rCODECIMEX" /></th>
		<td><s:textfield name="numRcCodeCimexOB"
...
<sx:div labelposition="top" key="RcReglementImportFB.ReglementImport" cssStyle="margin-down: 5px;" >
	...
	<tr>
		...
		<td><s:textfield name="rcCodeImpOB" id="rccodeimp_OB" maxlength="1"
		onkeyup="f9_Produits(TNUM_LIST_RCCODEPROD_OB,this,TNUM_LIST_RCPRECSENEGAL_OB,event)"
				cssClass="input200"/></td>
	</tr>
	<tr>
...
<sx:div labelposition="top" key="RcProduitsFB.ReglementExport" cssStyle="margin-down: 5px;" >
	...
	<tr>
		...
		<td><s:textfield name="rccodeexpOB" id="rccodeexp_OB" maxlength="255"
				cssClass="input200"/></td>
	</tr>
	<tr>
