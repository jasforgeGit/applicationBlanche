...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="3"><s:text
				name="RcRegimefiscalFB.SaisieRegimefiscal" /></th>
	</tr>
	<tr>
		<th><s:text name="RcRegimefiscalFB.TNUM_RCCODEREGIMEFISCAL_OB" /></th>
		<td><s:textfield name="numRcCodeRegimeFiscalOB"
	...
	<tr>
		...
		<td><s:textfield name="numIndRegExoOB" 
	...
	<tr>
		...
		<td><s:textfield name="numRcIndSuspensionOB" 
	...
	<tr>
		...
		<td><s:textfield name="numRcLibelleRegimeFiscalOB" 
