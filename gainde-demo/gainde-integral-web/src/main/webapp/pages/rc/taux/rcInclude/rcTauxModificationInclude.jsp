...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="4"><s:text
				name="RcTauxFB.ModificationTaux" /></th>
	</tr>
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numRcCodeTauxOB" id="TNUM_RCCODETAUX_OB"
				readonly="true" maxlength="3" cssClass="input100" /></div></td>
		...
		<td><div style="float: left;"><s:textfield name="numListRcCodeTaxeOB" readonly="true"
				id="TNUM_LIST_RCCODETAXE_OB" maxlength="2" cssClass="input100" /></div></td>
	</tr>
	<tr>
		<th><s:text name="RcTauxFB.DAT_RCDATEVALEUR_OB" /></th>
		<td><div style="float: left;"><s:textfield id="DAT_RCDATEVALEUR_OB"
				name="datRcDateValeurOB" readonly="true" maxlength="10"
