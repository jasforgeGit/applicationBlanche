...
sn.com.douane.web.rc.form.RcConsignatairesForm rcConsignatairesForm =
	 (sn.com.douane.web.rc.form.RcConsignatairesForm) pageContext.findAttribute("rcConsignatairesForm");
rcConsignatairesForm.setNumListRcCodePPM(codePpm);
 %>
...
<table class="SECTION">
	...
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numRcCodePartiel" id="TNUM_RCCODEPARTIEL"
				maxlength="1" cssClass="input200"/></div></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><div style="float: left;"><sj:datepicker id="DAT_RCDATEDECISION" name="datRcDateDecision" showOn="focus"
				displayFormat="dd/mm/yy" maxlength="10" cssClass="input200"/></div></td>
	...
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numRcIndSuspensCredit"
				id="TNUM_RCINDSUSPENSCREDIT" maxlength="1" cssClass="input200"/></div></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numRcNumSuspension"
				id="TNUM_RCNUMSUSPENSION" maxlength="6" cssClass="input200"/></div></td>
