...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="6"><s:text
				name="RcConsignatairesFB.ModificationConsignataires" /></th>
	</tr>
	<tr>
		<th><s:text name="RcConsignatairesFB.TNUM_RCCODECONSIGNATAIRE_OB" /></th>
		<td><div style="float: left;"><s:textfield name="numRcCodeConsignataireOB" readonly="true"
	...
	<tr>
		...
		<td><div style="float: left;"><s:textfield name="numListRcCodePPM" id="TNUM_LIST_RCCODEPPM"
				maxlength="5" onkeyup="f9_PPM1(this,event)" cssClass="input100"/></div></td>
