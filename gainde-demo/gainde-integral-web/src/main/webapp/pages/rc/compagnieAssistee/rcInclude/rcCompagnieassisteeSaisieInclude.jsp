...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="4"><s:text
				name="RcCompagnieassisteeFB.SaisieCompagnieassistee" /></th>
	</tr>
	<tr>
	...
	<tr>
				...
				<td><div style="float: left;"><s:textfield name="numNomCieAssisteeOB" 
						maxlength="100" cssClass="input300" /></div></td>
	</tr>
</table>
