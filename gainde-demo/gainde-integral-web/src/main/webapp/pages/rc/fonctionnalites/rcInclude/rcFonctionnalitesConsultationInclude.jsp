...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="2"><s:text
				name="RcFonctionnalitesFB.ConsultationFonctionnalites" /></th>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><s:textfield name="numListRcCodeProfil" id="TNUM_LIST_RCCODEPROFIL" maxlength="10" cssClass="input200" onkeyup="f9_Profil(this,event)" readonly="true"/></td>
	</tr>
	<tr>
		<th><s:text name="RcFonctionnalitesFB.NUM_RCORDREAFFICHAGE_OB" /></th>
		<td><s:textfield name="numRcOrdreAffichageOB" id="NUM_RCORDREAFFICHAGE_OB" maxlength="4" cssClass="input200" readonly="true"/></td>
	</tr>
	<tr>
		<th><s:text name="RcFonctionnalitesFB.TNUM_RCDESCRIPTION" /></th>
		<td><s:textfield name="numRcDescription" id="TNUM_RCDESCRIPTION" maxlength="255" cssClass="input400" readonly="true"/></td>
	</tr>
	<tr>
		<th><s:text name="RcFonctionnalitesFB.TNUM_RCLIBFONCTION_OB" /></th>
		<td><s:textfield name="numRcLibFonctionOB" id="TNUM_RCLIBFONCTION_OB" maxlength="100" cssClass="input400" readonly="true"/></td>
	</tr>
	<tr>
