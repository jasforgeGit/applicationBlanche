...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="4"><s:text
				name="RcGroupefonctionFB.SaisieGroupefonction" /></th>
	</tr>
	<tr>
		<th><s:text name="RcGroupefonctionFB.NUM_RCCODEGROUPE_OB" /></th>
		<td><s:textfield name="numRcCodeGroupeOB" id="NUM_RCCODEGROUPE_OB" maxlength="15" cssClass="input200" /></td>
...
<div style="float: left;">	
	<table>
		<tr>
			<td><s:submit key="button.save" cssClass="buttonBar" validate="true" action="enregistrerRcGroupefonction"></s:submit>
