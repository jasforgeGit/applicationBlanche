...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="3"><s:text
				name="RcTyperegimedouaneFB.ConsultationTyperegimedouane" /></th>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><s:textfield name="numRcImportExport" readonly="true"
	...
	<tr>
		...
		<td><s:textfield name="numRcLibelleRegime" readonly="true"
