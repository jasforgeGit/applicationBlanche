...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="4"><s:text
				name="RcImportexportFB.ModificationImportexport" /></th>
	</tr>
	<tr>
		...
		<td><s:textfield name="numListRcCodePPM" id="TNUM_LIST_RCCODEPPM"
				onkeyup="f9_PPM1(this)" maxlength="5" cssClass="input100" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><s:textfield name="numRcNumDecision" id="TNUM_RCNUMDECISION"
				onkeyup="f9_PPM1(this)" maxlength="6" cssClass="input100" /></td>
	</tr>
	<tr>
		<th><s:text name="RcImportexportFB.TNUM_RCNUMSUSPENSION" /></th>
		<td><s:textfield name="numRcNumSuspension"
				id="TNUM_RCNUMSUSPENSION" maxlength="6" cssClass="input00" /></td>
	</tr>
</table>