...
<table class="SECTION">
	<tr>
		<th class="ENTETE" colspan="5"><s:text
				name="RcProduitspjtFB.ConsultationProduitspjt" /></th>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><sj:datepicker id="DAT_RCDATEPIECEJOINTE" name="datRcDatePieceJointe" disabled="true"
				showOn="focus" displayFormat="dd/mm/yy" maxlength="10"
				cssClass="input200" /></td>
		<td width="20%"></td>
		<th><s:text name="RcProduitspjtFB.TNUM_RCIMPORTEXPORT" /></th>
		<td><s:textfield name="numRcImportExport" id="TNUM_RCIMPORTEXPORT" readonly="true"
