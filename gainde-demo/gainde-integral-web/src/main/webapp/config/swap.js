...
function swap(sSelectFrom, from, sSelectTo, to) {
	...
	var h=0;
	//alert(document.getElementById('stdLayoutSwapHS1').options.length);
	if(document.getElementById('swapSelected')){
	 if(document.getElementById('stdLayoutSwapHS1').options.length==0)
  	   document.getElementById('swapSelected').value='';
  	 }
	...
	if(document.getElementById('swapSelected')){
	  ...
	  for(var i=0; i<document.getElementById('stdLayoutSwapHS1').options.length; i++){
		ind=document.getElementById('swapSelected').value;
		if(ind.indexOf(document.getElementById('stdLayoutSwapHS1').options[i].value)==-1){	  
		  document.getElementById('swapSelected').value=document.getElementById('swapSelected').value+document.getElementById('stdLayoutSwapHS1').options[i].value+"##";
		}
	  }
	 // alert(document.getElementById('swapSelected').value);	  
	}
