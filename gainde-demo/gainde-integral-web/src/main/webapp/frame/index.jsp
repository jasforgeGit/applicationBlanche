...
<%
        ...
        try {
            ...
            typeuser = Session.getUtilisateurSession(request).getRcCodUser();
            ...
            if (typeuser.equals(sn.com.douane.utils.ConstManif.TYPE_USER_DECLARANT)) {
                ...
                nomUser = sn.com.douane.web.rc.Session.getMessageProperties("EnteteModule.nomUserConsignataire", request
                                .getLocale());
                codePpmUser = sn.com.douane.web.rc.Session
                        .getMessageProperties("EnteteModule.codePpmUser",
                                request.getLocale());
                codeCreditaireUser = sn.com.douane.web.rc.Session
                        .getMessageProperties(
                                "EnteteModule.codeCreditaireUser", request
                                        .getLocale());
                codeuser = Session.getCodeuser(request);
                ...
                nomEnteteUser = sn.com.douane.web.rc.Session
                        .getMessageProperties(
                                "EnteteModule.nomEnteteUserDouanier", request
                                        .getLocale());
                nomUser = sn.com.douane.web.rc.Session.getMessageProperties(
                        "EnteteModule.nomUserDouanier", request.getLocale());
                codePpmUser = sn.com.douane.web.rc.Session
                        .getMessageProperties(
                                "EnteteModule.codeAgentUserDouanier", request
                                        .getLocale());
                codeCreditaireUser = sn.com.douane.web.rc.Session
                        .getMessageProperties(
                                "EnteteModule.codeCreditaireUser", request
                ...
                nomEnteteUser = sn.com.douane.web.rc.Session
                        .getMessageProperties(
                                "EnteteModule.nomEnteteUserPercepteur", request
                                        .getLocale());
                nomUser = sn.com.douane.web.rc.Session.getMessageProperties(
                        "EnteteModule.nomUserPercepteur", request.getLocale());
                codePpmUser = sn.com.douane.web.rc.Session
                        .getMessageProperties(
                                "EnteteModule.codeUserPercepteur", request
                                        .getLocale());
                codeCreditaireUser = sn.com.douane.web.rc.Session
                        .getMessageProperties(
                                "EnteteModule.codeCreditaireUser", request
                ...
                nomEnteteUser = sn.com.douane.web.rc.Session
                        .getMessageProperties("EnteteModule.nomEnteteUserRc",
                                request.getLocale());
                nomUser = sn.com.douane.web.rc.Session.getMessageProperties(
                        "EnteteModule.nomUserRc", request.getLocale());
                codePpmUser = sn.com.douane.web.rc.Session
                        .getMessageProperties("EnteteModule.codeUserRc",
                                request.getLocale());
                codeCreditaireUser = sn.com.douane.web.rc.Session
                        .getMessageProperties("EnteteModule.codeCreditaireRc",
                                request.getLocale());
                codeuser = libProfil;
		...
		if(codePpmUser==null) codePpmUser="";
		if(codeCreditaireUser==null) codeCreditaireUser="";
		if(codeuser==null)codeuser="";
		if(codeIdentification==null)codeIdentification="";
		if(libIdentificationUser==null)libIdentificationUser="";
        ...
        if (pageF != null && !pageF.equals("") && !pageF.equals("menu")
                && !pageF.equals("Transbordement.menu") && !pageF.equals("index")) {
            try {
                if (pageF.equals("rechercheManifeste") && ctxmenu != null
                        && !ctxmenu.equals(""))
                    label = sn.com.douane.web.rc.Session.getMessageProperties(
                            "menu." + ctxmenu, request.getLocale());
                else if (pageF.equals("rechercherCredit") && ctxmenu != null
                        && !ctxmenu.equals(""))
                    label = sn.com.douane.web.rc.Session.getMessageProperties(
                            "menu." + ctxmenu, request.getLocale());
                    ...
                    label = sn.com.douane.web.rc.Session.getMessageProperties(
                            "menu." + ctxmenu.trim(), request.getLocale());
                    ...
                    label = sn.com.douane.web.rc.Session.getMessageProperties(
                            "menu." + ctxmenu.trim(), request.getLocale());
                else if (pageF.equals("DemandesDeclaration.editArticlesForm")
                        && ctxmenu != null && !ctxmenu.equals(""))
                    label = sn.com.douane.web.rc.Session.getMessageProperties(
                            "menu." + ctxmenu.trim(), request.getLocale());
                else 
                    label = sn.com.douane.web.rc.Session.getMessageProperties(
                            "menu." + pageF.trim(), request.getLocale());
...
<body onload="FirstTime();if(document.forms[0]&&document.forms[0].action.indexOf('saisieManifesteACT')!=-1&&document.forms[0].hid){truc();FirstTime();}">
	...
	<table cellspacing="1" cellpadding="0" border="0" width="800"
		...
		<tr>
			<td align="left" bgcolor="#fffbff" valign="top" height="15"><s:actionerror />
				<s:actionmessage /></td>
		</tr>
		<tr align="center">
		...
		<tr>
			<td bgcolor="#FFFFFF" valign="top">
				<table cellspacing="1" cellpadding="1" border="0" width="100%"
					...
					<tr valign="top">
						<td align="center"><tiles:insertAttribute name="content" />
						</td>
					</tr>
				</table></td>
		</tr>
