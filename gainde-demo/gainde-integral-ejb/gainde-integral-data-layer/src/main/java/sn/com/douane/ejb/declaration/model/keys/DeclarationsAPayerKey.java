...
public class DeclarationsAPayerKey implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -7096334344216714790L;
	...
	public DeclarationsAPayerKey() {
		super();
	}

	public DeclarationsAPayerKey(String anDcl, String burDcl, Integer numDcl) {
		super();
		this.anDcl = anDcl;
		this.burDcl = burDcl;
		this.numDcl = numDcl;
	...
	public boolean equals(Object obj) {
		...
		DeclarationsAPayerKey other = (DeclarationsAPayerKey) obj;
		if (anDcl == null) {
			if (other.anDcl != null){
				return false;
			}
