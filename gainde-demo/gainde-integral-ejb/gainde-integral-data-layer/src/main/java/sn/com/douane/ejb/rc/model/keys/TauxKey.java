...
public class TauxKey implements java.io.Serializable {
	
	
	private static final long serialVersionUID = 3008805466634820297L;
	...
	public TauxKey(String rcCodeTaux,String rcCodeTaxe,Date rcDateValeur){		
		this.rcCodeTaux = rcCodeTaux;
		this.rcCodeTaxe = rcCodeTaxe;
		this.rcDateValeur = rcDateValeur;
	}
