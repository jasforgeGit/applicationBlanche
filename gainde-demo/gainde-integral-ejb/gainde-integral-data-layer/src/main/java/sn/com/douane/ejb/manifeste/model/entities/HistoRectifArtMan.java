...
import sn.com.douane.ejb.manifeste.model.keys.HistoRectifArtManKey;
 ...
 */
@Entity
@Table(name = "HISTORECTIFARTMAN")
@IdClass(HistoRectifArtManKey.class)

public class HistoRectifArtMan implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -9107716736688701489L;
   ...
   @OneToMany(mappedBy = "histoRectifArtMan" , targetEntity = HistoRectifContMan.class)
    private List<HistoRectifContMan> histoRectifContMans;

	/**
	 * 
	 */
	public HistoRectifArtMan() {
	 ...
	 * @param histoRectifContMan
	 */
	public HistoRectifArtMan(String manifAnneeEnreg, String manifBurManif,
			Integer manifNumEnregManif, Integer manifNumArtManif,
			Integer manifPrecisArtManif, Integer manifPrecisArtManif2,
			Timestamp manifDateHisto, String manifNumRepertoire,
			...
			String manifCodeDestDef, List<HistoRectifContMan> histoRectifContMan) {
		super();
		...
		this.histoRectifContMans = histoRectifContMan;
	}
	...
	/**
	 * @return the histoRectifContMan
	 */
	public List<HistoRectifContMan> getHistoRectifContMan() {
		return histoRectifContMans;
	}

	/**
	 * @param histoRectifContMan the histoRectifContMan to set
	 */
	public void setHistoRectifContMan(List<HistoRectifContMan> histoRectifContMan) {
		this.histoRectifContMans = histoRectifContMan;
	}
