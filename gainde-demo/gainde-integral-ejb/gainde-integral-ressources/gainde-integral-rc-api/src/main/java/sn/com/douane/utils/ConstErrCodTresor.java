...
public class ConstErrCodTresor {
    ...
    //******************************************************************//
    //				constantes error Cles primaires			            //
    //******************************************************************//
	...
	public static final String AUCUNEDECLPOURCEDOSSIER = "message.declDossier";	
	public static final String DELETEDOSPROVISOIRE="message.deleteDosProvisoire";
	public static final String CREDITAIRE_NON_AUTORISE = "error.creditaireNonAutorise";
