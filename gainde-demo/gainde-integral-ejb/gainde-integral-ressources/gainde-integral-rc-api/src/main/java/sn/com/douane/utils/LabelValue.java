...
public class LabelValue implements Comparable<Object>, Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2112129782209164828L;
	...
	private String rcCodeModRegl;
	private String rcLibModRegl;
	private BigDecimal totalMnt;
	...
	public String getRcCodeModRegl() {
		return rcCodeModRegl;
	}

	public void setRcCodeModRegl(String rcCodeModRegl) {
		this.rcCodeModRegl = rcCodeModRegl;
	}

	public String getRcLibModRegl() {
		return rcLibModRegl;
	}

	public void setRcLibModRegl(String rcLibModRegl) {
		this.rcLibModRegl = rcLibModRegl;
	}

	public BigDecimal getTotalMnt() {
		return totalMnt;
	}

	public void setTotalMnt(BigDecimal totalMnt) {
		this.totalMnt = totalMnt;
	}
